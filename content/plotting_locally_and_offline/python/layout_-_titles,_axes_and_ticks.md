...
A slightly more complex method is to define the interval between each tick.  With our plot, let's say we want to go up in units of 10 years.  We do this with ```dtick```, the 'd' probably standing for 'delta'.
